...
Name: Brian George
Date: 6 Jan 20
Project: Variables Performance Lab 1

Objectives:
	1) Display the contents of the following variable types: int, float, double, and char
	2) Display the size of the following data types: int, float, double, and char
*/
